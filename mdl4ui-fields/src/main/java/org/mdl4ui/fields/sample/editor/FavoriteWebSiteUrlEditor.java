...
@InjectSampleEditor(@OnField({ EFieldSample.FAVORITE_SITE_URL_1,
                EFieldSample.FAVORITE_SITE_URL_2,
                EFieldSample.FAVORITE_SITE_URL_3 }))
public class FavoriteWebSiteUrlEditor extends SampleEditor {
    ...
    protected void updateFromContext(Field field, SampleContext context, FieldEvent fieldEvent) {
        ...
        if (webSite != null) {
            ...
            textbox.setValue(webSite.getUrl());
        }
    }
