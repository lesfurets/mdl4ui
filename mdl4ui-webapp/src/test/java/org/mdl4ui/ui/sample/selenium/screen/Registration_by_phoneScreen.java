...
public class Registration_by_phoneScreen extends AbstractSeleniumScreen<Registration_by_phoneScreen> {
    ...
    public Registration_by_phoneScreen(WebDriver driver) {
        super(driver);
